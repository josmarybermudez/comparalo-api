...
class ProductScraper:
    """Web scraper for Disco.com.ar product data using JSON-LD structured data"""
    
    def __init__(self, search_term: str = "bebidas", max_products: int = 20):
        self.search_term = search_term
        self.url = f"https://www.disco.com.ar/{search_term}?_q={search_term}&map=ft"
    ...
    def scrape(self) -> tuple[List[Dict], Optional[str]]:
        """
        Scrape product data from Disco.com.ar using JSON-LD structured data
    ...
    def _extract_from_state_object(self, html_content: str) -> List[Dict]:
        ...
        This is the most reliable method for VTEX/Disco.com.ar
        """
        products = []
    ...
    def _extract_from_html(self, soup: BeautifulSoup) -> List[Dict]:
        ...
        For Disco.com.ar VTEX platform
        """
        products = []
...
def run_scraper(search_term: str = "bebidas"):
    ...
    try:
        ...
        # db.clear_products(store='disco')
        db.insert_products(products, store='disco')
