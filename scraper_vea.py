...
class ProductScraper:
    """Web scraper for vea.com.ar product data using JSON-LD structured data"""
    
    def __init__(self, search_term: str = "bebidas", max_products: int = 20):
        self.search_term = search_term
        self.url = f"https://www.vea.com.ar/{search_term}?_q={search_term}&map=ft"
    ...
    def scrape(self) -> tuple[List[Dict], Optional[str]]:
        """
        Scrape product data from vea.com.ar using JSON-LD structured data
    ...
    def _extract_from_state_object(self, html_content: str) -> List[Dict]:
        ...
        This is the most reliable method for VTEX/vea.com.ar
        """
        products = []
...
def run_scraper(search_term: str = "bebidas"):
    ...
    try:
        ...
        # db.clear_products(store='vea')
        db.insert_products(products, store='vea')
...
if __name__ == "__main__":
    ...
    print(f"📍 URL will be: https://www.vea.com.ar/{search_term}?_q={search_term}&map=ft\n")
